...
namespace MangGuoTv.Popups
{
    ...
    internal  class PopupManager
    {
        ...
        public static bool IsReloadAccount = false;
         ...
         private static CommentControl _CommentControl;
         /// <summary>
         /// 忘记密码UserControl
         /// </summary>
         public static CommentControl CommentControl
         {
             get
             {
                 if (_CommentControl == null)
                 {
                     ...
                     _CommentControl.Width = screenWidth;
                     _CommentControl.Height = screenHeight;
                 }
